...
col1, col2,col3 = st.beta_columns([2,2,10])
with col1:
...
for i in range(choice):
    ...
    if selected:
        col1_1, col1_4, col1_2 = st.beta_columns([2,4,20])
        col1_3,col1_6 = st.beta_columns([8,1])
        col1_5,col1_7 = st.beta_columns(2)
    else:
        col1_1, col1_2, col1_4,col1_3,col1_5,col1_6  = st.beta_columns([2,3,3,10,4,1])
